...
function reposition(platform, pos, rot) {
  ...
  if (platform.track) {
    ...
    platform.track._ports.TrackConnection0._pos = trackPos;
    platform.track._ports.TrackConnection0._dir = trackDir;
    platform.track._ports.TrackConnection1._pos = trackEnd;
    platform.track._ports.TrackConnection1._dir = trackDir;
    platform.track.onPortSnapped();
  }
}

...
const PORT_LAYOUT = {
  ...
  Input2:  { offset: { x: 0, y:  100, z: 0 }, dir: { x:  0, y: 1, z: 0 }, flow: 'input',  type: PortType.BELT },
  Input3:  { offset: { x: 0, y: -100, z: 0 }, dir: { x:  0, y: -1, z: 0 }, flow: 'input',  type: PortType.BELT },
  Output1: { offset: { x:  100, y: 0, z: 0 }, dir: { x:  1, y: 0, z: 0 }, flow: 'output', type: PortType.BELT },
};

class ConveyorMerger extends SnapBuilder {
...
ConveyorMerger.PORT_LAYOUT = PORT_LAYOUT;

...
const PORTS = {
  Input0:                  { offset: { x: -200, y: 2288, z: 100 }, dir: { x: 0, y: 1, z: 0 }, flow: 'input',  type: PortType.BELT },
  Output0:                 { offset: { x:  200, y: 2288, z: 100 }, dir: { x: 0, y: 1, z: 0 }, flow: 'output', type: PortType.BELT },
...
class NukePlant extends Builder {
  constructor(entity, pipeConn, powerConnComp) {
    super(entity, [pipeConn, powerConnComp]);
    this._initPorts([pipeConn, powerConnComp], PORTS);
  }

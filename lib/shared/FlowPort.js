...
class FlowPort {
  ...
  snapTo(anchor) {
    ...
    // Only mobile entities (with onPortSnapped) or ownerless ports (supports/poles) can snap.
    // Fixed entities (producers, extractors) must use a belt/pipe/lift to connect.
    ...
    // Splitter/merger/junction/pump can only snap onto spline entity endpoints (belt/pipe/lift)
    // Not onto producers, extractors, poles, or other fixed-clearance entities
